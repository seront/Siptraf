...
public class UsuarioJpaController implements Serializable {
    ...
    private List<Usuario> findUsuarioEntities(boolean all, int maxResults, int firstResult) {
        ...
        public Usuario validarUsuario(Usuario usr) {
        EntityManager em = getEntityManager();
        try {
            TypedQuery<Usuario> cq=em.createNamedQuery("Usuario.validarUsuario",Usuario.class);
            cq.setParameter("idUsuario", usr.getIdUsuario());
            cq.setParameter("clave", usr.getClave());
